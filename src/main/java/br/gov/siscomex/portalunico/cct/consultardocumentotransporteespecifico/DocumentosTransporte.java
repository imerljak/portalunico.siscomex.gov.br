...
public class DocumentosTransporte {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(numeroDocumentoTransporte, that.numeroDocumentoTransporte) &&
                Objects.equals(tipoDocumentoTransporte, that.tipoDocumentoTransporte) &&
                Objects.equals(viaTransporte, that.viaTransporte) &&
                Objects.equals(situacaoAtual, that.situacaoAtual) &&
                Objects.equals(dataEmissao, that.dataEmissao) &&
                Objects.equals(cpfCnpjTransportador, that.cpfCnpjTransportador) &&
                Objects.equals(nomeTransportador, that.nomeTransportador) &&
                Objects.equals(tipoDAT, that.tipoDAT) &&
                Objects.equals(localOrigem, that.localOrigem) &&
                Objects.equals(localDestinoPrevisto, that.localDestinoPrevisto) &&
                Objects.equals(localEstoque, that.localEstoque) &&
                Objects.equals(veiculoFerroviario, that.veiculoFerroviario) &&
                Objects.equals(veiculoRodoviario, that.veiculoRodoviario) &&
                Objects.equals(cargas, that.cargas) &&
                Objects.equals(conteineres, that.conteineres);
    }

    @Override
    public int hashCode() {
        return Objects.hash(numeroDocumentoTransporte, tipoDocumentoTransporte, viaTransporte, situacaoAtual, dataEmissao, cpfCnpjTransportador, nomeTransportador, tipoDAT, localOrigem, localDestinoPrevisto, localEstoque, veiculoFerroviario, veiculoRodoviario, cargas, conteineres);
    }

    @Override
    public String toString() {
        return "DocumentosTransporte{" +
                "numeroDocumentoTransporte='" + numeroDocumentoTransporte + '\'' +
                ", tipoDocumentoTransporte='" + tipoDocumentoTransporte + '\'' +
                ...
                ", localDestinoPrevisto=" + localDestinoPrevisto +
                ", localEstoque=" + localEstoque +
                ", veiculoFerroviario=" + veiculoFerroviario +
