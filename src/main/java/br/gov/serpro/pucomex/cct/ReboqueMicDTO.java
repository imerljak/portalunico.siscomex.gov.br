...
/**
 * <p>Classe Java de ReboqueMicDTO complex type.
 *
...
@XmlType(name = "ReboqueMicDTO", namespace = "http://www.pucomex.serpro.gov.br/cct", propOrder = {
        "placa",
        "tara",
        "lacres"
})
public class ReboqueMicDTO {
    ...
    protected ReboqueMicDTO.Lacres lacres;
     ...
     * @return
     *     possible object is
     *     {@link ReboqueMicDTO.Lacres }
     *
     */
    public ReboqueMicDTO.Lacres getLacres() {
        return lacres;
    }
     ...
     *
     */
    public void setLacres(ReboqueMicDTO.Lacres value) {
        this.lacres = value;
    }
