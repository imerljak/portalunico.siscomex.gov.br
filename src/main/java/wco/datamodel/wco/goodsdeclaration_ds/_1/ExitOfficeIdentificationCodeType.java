...
@XmlType(name = "ExitOfficeIdentificationCodeType", propOrder = {
    "value"
})
@Builder(builderMethodName = "exitOfficeIdentificationCodeTypeBuilder")
@AllArgsConstructor
@NoArgsConstructor
@Data
public class ExitOfficeIdentificationCodeType {
