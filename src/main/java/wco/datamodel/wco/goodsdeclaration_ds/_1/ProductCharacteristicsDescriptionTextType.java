...
@XmlType(name = "ProductCharacteristicsDescriptionTextType", propOrder = {
    "value"
})
@Builder(builderMethodName = "productCharacteristicsDescriptionTextTypeBuilder")
@AllArgsConstructor
@NoArgsConstructor
@Data
public class ProductCharacteristicsDescriptionTextType {
